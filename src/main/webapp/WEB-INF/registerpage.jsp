...
<t:genericpage>
    ...
    <jsp:body>
        ...
        <form name="login" action="${pageContext.request.contextPath}/fc/registercommand" method="POST">
            ...
            <div class="row mt-5">
                <div class="col">
                <input id="firstname" class="form-control" type="text" name="firstname" required value="${param.firstname}" placeholder="Indtast dit fornavn">
                </div>
                <div class="col">
                <input id="lastname" class="form-control" type="text" name="lastname" required value="${param.lastname}" placeholder="Indtast dit efternavn">
            </div></div>
